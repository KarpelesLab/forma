...
use stipple_geometry::{PhysicalSize, ScaleFactor, Size};
use stipple_render::Surface;
...
///
/// Backends implement this; the rest of Stipple drives windows only through this
